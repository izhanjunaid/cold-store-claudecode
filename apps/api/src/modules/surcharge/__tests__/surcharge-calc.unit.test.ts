...
describe('JE-21 late payment surcharge', () => {
  it('debits party AR, credits 4210, balanced, SURCHARGE entry type', () => {
    ...
    expect(draft.entryType).toBe('SURCHARGE');
    expect(draft.sourceTable).toBe('invoice_surcharges');
    expect(draft.sourceId).toBe('s1');
