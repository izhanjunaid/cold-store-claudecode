...
const cards: ReportCard[] = [
  ...
  { title: 'Withholding Tax', href: '/reports/withholding-tax', icon: Receipt, permission: 'reports.financial', description: 'Tax deducted at source by section — the figures behind a s.165 statement.' },
];
